...
class FormationFlying(Model):
 ...
 # =========================================================================
    def __init__(
        ...
        joining_method = 0,
        n_manager = 20,
        max_bid_contractor = 0.4, 
        min_bid_auctioneer = 0.4,
        true_value_av_amount_per = 0.4,
    ):
...
#ADDED
        ...
        self.amount_managers = round((self.n_manager/100)*self.n_flights)
        ...
        self.true_value_av_amount = true_value_av_amount_per*(n_manager/100)*n_flights
        self.max_bid_contractor = max_bid_contractor #[%]
        self.min_bid_auctioneer = min_bid_auctioneer #[%]
        self.total_agents_arrived = 0
        self.total_arrival_time = 0
        self.individual_arrival_time = []
        self.make_airports()
        self.make_agents()
        self.running = True
        self.total_alliance_savings = 0
        self.total_nonalliance_savings = 0
        self.total_manager_savings = 0
        self.total_contractor_savings = 0
        self.amount_alliance_members = round((self.alliance_amount)*self.n_flights)
        self.width = width
        self.height = height
